...
def get_database_paths() -> dict:
    ...
    if platform_code == 2:
        ...
        abs_chrome_path = os.path.join(homepath, 'AppData', 'Local', 'Google', 'Chrome Beta', 'User Data', 'Default', 'History')
...
def write_browserhistory_txt() -> None:
